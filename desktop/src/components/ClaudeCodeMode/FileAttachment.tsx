...
const SUPPORTED_TEXT_EXTENSIONS = [
  ...
  'java', 'kt', 'swift', 'c', 'cpp', 'h', 'hpp', 'cs', 'php', 'html',
  'css', 'scss', 'less', 'xml', 'yaml', 'yml', 'toml', 'ini', 'cfg',
...
export function useFileReferences(
  _workspaceFiles: FileReference[] = []
): UseFileReferencesResult {
