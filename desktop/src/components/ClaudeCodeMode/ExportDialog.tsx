...
import { Cross2Icon, DownloadIcon, FileTextIcon, CodeIcon, FileIcon, CheckIcon, CopyIcon } from '@radix-ui/react-icons';
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <Dialog.Close asChild>
              <button className="p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500" aria-label="Close">
