  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Quality Gates</label>
        <button
      ...
      <div className="space-y-2">
              ...
              <label className="flex items-center gap-3 cursor-pointer flex-1">
                ...
                <div className="flex-1">
                  <span
                    className={clsx(
                      'font-medium',
                      gate.enabled ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400',
                    )}
                  >
                    {gate.name}
                  </span>
                  {gate.command && (
                    <span className="ml-2 text-xs text-gray-400 dark:text-gray-500 font-mono">{gate.command}</span>
                  )}
                </div>
              </label>
        ...
        {isAddingCustom ? (
          ...
          >
            <div className="space-y-3">
              <div>
                <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Gate Name</label>
                <input
                  type="text"
                  value={customName}
