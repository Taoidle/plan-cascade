  ...
  return (
    <div className="w-full p-4" aria-hidden="true">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="h-6 w-32 bg-gray-200 dark:bg-gray-700 rounded animate-skeleton" />
        <div className="h-8 w-24 bg-gray-200 dark:bg-gray-700 rounded animate-skeleton" />
      </div>

      {/* Branch selector skeleton */}
      <div className="h-10 w-48 bg-gray-200 dark:bg-gray-700 rounded mb-6 animate-skeleton" />
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="flex items-start gap-4">
            ...
            >
              ...
              <div className="h-3 w-1/4 bg-gray-100 dark:bg-gray-800 rounded mb-3 animate-skeleton" />
