//! Proxy Configuration & HTTP Client Factory
//!
//! Provides proxy types and a factory function for building reqwest clients
//! with proxy support (HTTP, HTTPS, SOCKS5). Used by all LLM and embedding
//! providers to route traffic through user-configured proxies.
