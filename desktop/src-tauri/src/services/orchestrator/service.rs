...
use crate::services::tools::{
    ...
    format_tool_result, get_basic_tool_definitions, get_basic_tool_definitions_from_registry,
    get_tool_definitions, get_tool_definitions_from_registry, merge_system_prompts,
