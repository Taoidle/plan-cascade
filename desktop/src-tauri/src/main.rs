...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            plan_cascade_desktop::commands::worktree::workflow_create_isolated_session,
            plan_cascade_desktop::commands::worktree::workflow_move_session_to_worktree,
            plan_cascade_desktop::commands::worktree::workflow_attach_session_worktree,
            plan_cascade_desktop::commands::worktree::workflow_detach_session_worktree,
            plan_cascade_desktop::commands::worktree::workflow_cleanup_session_worktree,
            plan_cascade_desktop::commands::worktree::workflow_list_repo_worktrees,
            plan_cascade_desktop::commands::worktree::workflow_prepare_session_pr,
            plan_cascade_desktop::commands::worktree::workflow_create_session_pr,
            plan_cascade_desktop::commands::worktree::set_forge_token,
            plan_cascade_desktop::commands::worktree::has_forge_token,
