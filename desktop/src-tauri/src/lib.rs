...
pub use commands::{
    ...
    list_worktrees,
    preview_install_mcp_catalog_item,
    prune_agent_runs,
    rag_delete_collection,
    rag_get_observability_metrics,
    // Knowledge commands
    rag_ingest_documents,
    rag_list_collections,
    rag_list_query_runs,
    rag_query,
    rag_record_ingest_crosstalk_alert,
    rag_record_picker_search,
